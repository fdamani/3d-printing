...
M109 S{clean_temperature}    ; soften filament for z homing, 70% of extrusion temperature is fine. default=170. 
G28 Z                        ; home Z
M104 S{clean_temperature}    ; wipe temp, 70% of extrusion temperature is fine. default=160
...
M109 S{clean_temperature}    ; heat to probe temp. probe temp is 70% of extrusion temperature (print_temperature). default=160
